...
exports.default = {
  ...
  methods: {
    ...
    // 获取数据
    getNews: function getNews(url, cb) {
      return stream.fetch({
        method: 'GET',
        type: 'json',
        url: url
  ...
  created: function created() {
    ...
    var url = "http://localhost:3000/newsInfo";
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('list', _vm._l((_vm.lists), function(rum) {
    return _c('cell', {
      key: rum.id,
      appendAsTree: true,
      attrs: {
    ...
    }, [_vm._v(_vm._s(rum.newsTitle))]), _c('text', {
      staticClass: ["list_content"]
    }, [_vm._v(_vm._s(rum.newsContent))])])])
  }))])
},staticRenderFns: []}
module.exports.render._withStripped = true
